...
public abstract class AutoCompleteCursorAdapter extends CursorAdapter {
	...
	/**
	 * Method used in runQueryOnBackgroundThread to update auto complete data. Return the cursor which queries the data
	 * for this adapter.
	 * 
	 * @author wexoo
	...
	/**
	 * Get the display value for the drop down and the text view. Return values needed from the cursor.
	 * 
	 * @author wexoo
