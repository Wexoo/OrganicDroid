...
/**
 * Displays a list view in alphabetized order - implemented following the guide from
...
public class SearchResultAlphabetizedAdapter extends SimpleCursorAdapter implements SectionIndexer {
	...
	private static final String TAG = SearchResultAlphabetizedAdapter.class.getSimpleName();
	...
	public SearchResultAlphabetizedAdapter(final Context context, final int layout, final Cursor c, final String[] from,
				final int[] to) {
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		...
		// }
		// // ((TextView) convertView.findViewById(R.id.header)).setText((String)
