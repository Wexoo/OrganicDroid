...
/**
 * Specifies all the different fields available for the environment data.
 */
public enum AppEnvironmentField {
	
	/**
	 * Application version code. This is the incremental integer version code used to differentiate versions on the
	 * android market.
	 * 
